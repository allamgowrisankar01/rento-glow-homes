...
const Footer = () => {
  return (
    <footer className="fixed bottom-0 left-0 right-0 backdrop-blur-xl bg-black/90 border-t border-white/10 p-4 shadow-2xl">
      <div className="grid grid-cols-4 gap-2 text-center max-w-md mx-auto">
        ...
        <button className="flex flex-col items-center space-y-1 text-gray-400 hover:text-pink-400 transition-colors duration-300">
          <div className="w-6 h-6 rounded-full backdrop-blur-xl bg-black/20 border border-white/20"></div>
