  ...
  return (
    <header className={`sticky top-0 z-50 backdrop-blur-xl border-b transition-all duration-300 ${
      isDark 
        ...
        : 'bg-white/80 border-pink-200/50 shadow-[0_8px_32px_rgba(255,28,103,0.15)]'
    }`}>
      <div className="flex items-center justify-between px-6 py-5 max-w-md mx-auto lg:max-w-2xl">
        <div className="flex items-center space-x-4">
          <button className={`p-3 rounded-2xl transition-all duration-300 transform ${
            isDark 
              ? 'bg-[#362c5d] shadow-[4px_4px_8px_#2a2048,_-4px_-4px_8px_#423572] hover:shadow-[6px_6px_12px_#2a2048,_-6px_-6px_12px_#423572] hover:scale-105 active:shadow-[inset_2px_2px_4px_#2a2048,_inset_-2px_-2px_4px_#423572] active:scale-95' 
              : 'bg-gradient-to-br from-pink-50 to-pink-100 shadow-[4px_4px_8px_#f8d7da,_-4px_-4px_8px_#ffffff] hover:shadow-[6px_6px_12px_#f8d7da,_-6px_-6px_12px_#ffffff] hover:scale-105 active:shadow-[inset_2px_2px_4px_#f8d7da,_inset_-2px_-2px_4px_#ffffff] active:scale-95'
          }`}>
